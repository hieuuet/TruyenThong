...
class PayTelevision extends Component {
    ...
    constructor(props){
        ...
        const providerOptions = [
            {value: 'VTVCABBILL',label: 'Truyền hình cáp Việt Nam', des: 'Thanh toán hóa đơn VTVCab', type: 'BILLING'},
            {value: 'KPLUSBILLING',label: 'Truyền hình K+', des: 'Thanh toán hóa đơn K+', type: 'BILLING'},
            {value: 'VNPTHNBILLING',label: 'MyTV Hà Nội', des: 'Thanh toán MyTV Hà Nội', type: 'BILLING'},
            {value: 'VNPTHCMBILLING',label: 'MyTV Hồ Chí Minh', des: 'Thanh toán MyTV Hồ Chí Minh', type: 'BILLING'}
        ];
    ...
    onPayBill = () => {
      Util.showConfirm('Bạn có chắc chắn muốn thanh toán hóa đơn truyền hình?\nSố tiền: ' + this.state.formattedAmount, this.onPay.bind(this));
    }
            ...
            <View style={styles.container}>
                ...
                <ScrollView style={{zIndex: 5}} keyboardShouldPersistTaps={'handled'}>
                    <View style={styles.header}>
                        ...
                        <Image source={require('../../images/utilities/small/hoadontruyenhinh.png')} resizeMode="contain" style={styles.coverIcon} />
                        <Text style={styles.pageTitle}>THANH TOÁN HÓA ĐƠN TRUYỀN HÌNH</Text>

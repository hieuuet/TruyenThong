...
class PayFlight extends Component {
    ...
    constructor(props){
        ...
        const providerOptions = [
            {value: 'VNABILLING',label: 'Vietnam Airlines', des: 'Thanh toán vé máy bay Vietnam Airlines', type:'PAYLATER'},
            {value: 'VJABILLING', label: 'VietjetAir', des: 'Thanh toán vé máy bay Vietjet Air', type:'PAYLATER'},
            {value: 'AASBILLING', label: 'AirAsia Airlines', des: 'Thanh toán vé máy bay AirAsia Airlines', type:'PAYLATER'}
        ];
    ...
    onPayBill = () => {
      Util.showConfirm('Bạn có chắc chắn muốn thanh toán hóa đơn vé máy bay?\nSố tiền: ' + this.state.formattedAmount, this.onPay.bind(this));
    }
            ...
            <View style={styles.container}>
                ...
                <ScrollView style={{zIndex: 5}} keyboardShouldPersistTaps={'handled'}>
                    <View style={styles.header}>
                        ...
                        <Image source={require('../../images/utilities/small/vemaybay.png')} resizeMode="contain" style={styles.coverIcon} />
                        <Text style={styles.pageTitle}>THANH TOÁN VÉ MÁY BAY</Text>
                    ...
                    <View style={[globalStyles.contentCard]}>
                        ...
                        <Text style={globalStyles.label}>MÃ ĐẶT CHỖ</Text>
                    ...
                    <View style={[globalStyles.contentCard]}>
                        ...
                        <View style={styles.billRow}>
                            <Text style={styles.billRowTitle}>MÃ ĐẶT CHỖ</Text>

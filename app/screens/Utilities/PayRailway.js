...
class PayRailway extends Component {
    ...
    constructor(props){
        ...
        const providerOptions = [
            {value: 'VNRBILLING',label: 'Đường sắt Việt Nam', des: 'Thanh toán vé tàu Đường sắt Việt Nam', type: 'PAYLATER'}
        ];
    ...
    onPayBill = () => {
      Util.showConfirm('Bạn có chắc chắn muốn thanh toán hóa đơn vé tàu?\nSố tiền: ' + this.state.formattedAmount, this.onPay.bind(this));
    }
            ...
            <View style={styles.container}>
                ...
                <ScrollView style={{zIndex: 5}} keyboardShouldPersistTaps={'handled'}>
                    <View style={styles.header}>
                        ...
                        <Image source={require('../../images/utilities/small/vetau.png')} resizeMode="contain" style={styles.coverIcon} />
                        <Text style={styles.pageTitle}>THANH TOÁN VÉ TÀU</Text>

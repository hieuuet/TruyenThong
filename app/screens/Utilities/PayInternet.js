...
class PayInternet extends Component {
    ...
    constructor(props){
        ...
        const providerOptions = [
            {value: 'VNPTHNBILLING',label: 'VNPT Hà Nội', des : 'Thanh toán Internet VNPT Hà Nội',  type : 'BILLING'},
            {value: 'VNPTHCMBILLING',label: 'VNPT Hồ Chí Minh', des : 'Thanh toán Internet VNPT Hồ Chí Minh',  type : 'BILLING'},
            {value: 'SSTADSBILL', label: 'Internet Nam Sài Gòn', des : 'Thanh toán Internet Nam Sài Gòn',  type : 'BILLING'},
            {value: 'VTLADSL', label: 'Internet Viettel', des : 'Thanh toán Internet Viettel',  type : 'BILLING'},
            {value: 'STCBILLING', label: 'Internet SPT', des : 'Thanh toán Internet SPT',  type : 'BILLING'},
            {value: 'IPKBILLING', label: 'iParking', des : 'Thanh toán iParking',  type : 'BILLING'}
        ];
    ...
    onPayBill = () => {
      Util.showConfirm('Bạn có chắc chắn muốn thanh toán hóa đơn Internet?\nSố tiền: ' + this.state.formattedAmount, this.onPay.bind(this));
    }
            ...
            <View style={styles.container}>
                ...
                <ScrollView style={{zIndex: 5}} keyboardShouldPersistTaps={'handled'}>
                    <View style={styles.header}>
                        ...
                        <Image source={require('../../images/wifi.png')} resizeMode="contain" style={styles.coverIcon} />
                        <Text style={styles.pageTitle}>THANH TOÁN INTERNET</Text>
                    ...
                    <View style={[globalStyles.contentCard]}>
                        ...
                        <Text style={globalStyles.label}>MÃ KHÁCH HÀNG</Text>
                    ...
                    <View style={[globalStyles.contentCard]}>
                        ...
                        <View style={styles.billRow}>
                            <Text style={styles.billRowTitle}>MÃ KHÁCH HÀNG</Text>

...
@implementation IJKVideo2ViewController
...
+ (void)presentFromViewController:(UIViewController *)viewController withTitle:(NSString *)title URL:(NSURL *)url completion:(void (^)())completion {
    ...
    [viewController presentViewController:[[IJKVideo2ViewController alloc] initWithURL:url] animated:YES completion:completion];
}
